...
- **User flagged: expect to revise the carousel template/brand system after seeing the first real generated images** — don't treat this as final, be ready to adjust.
- Next: once KIE AI credits land, generate the actual images for these 3 prompts and review.
